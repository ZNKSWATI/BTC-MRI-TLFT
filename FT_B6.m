...
layers(4).WeightLearnRateFactor = 0;
layers(4).BiasLearnRateFactor = 0;

%B2 Freez Learning
layers(7).WeightLearnRateFactor = 0;
layers(7).BiasLearnRateFactor = 0;
layers(9).WeightLearnRateFactor = 0;
layers(9).BiasLearnRateFactor = 0;
...
layers(16).WeightLearnRateFactor = 0;
layers(16).BiasLearnRateFactor = 0;
layers(18).WeightLearnRateFactor = 0;
layers(18).BiasLearnRateFactor = 0;

%B4 Freez Learning
layers(21).WeightLearnRateFactor = 0;
layers(21).BiasLearnRateFactor = 0;
layers(23).WeightLearnRateFactor = 0;
layers(23).BiasLearnRateFactor = 0;
layers(25).WeightLearnRateFactor = 0;
layers(25).BiasLearnRateFactor = 0;
layers(27).WeightLearnRateFactor = 0;
layers(27).BiasLearnRateFactor = 0;

%B5 Freez Learning
layers(30).WeightLearnRateFactor = 0;
layers(30).BiasLearnRateFactor = 0;
layers(32).WeightLearnRateFactor = 0;
layers(32).BiasLearnRateFactor = 0;
layers(34).WeightLearnRateFactor = 0;
layers(34).BiasLearnRateFactor = 0;
layers(36).WeightLearnRateFactor = 0;
layers(36).BiasLearnRateFactor = 0;
...
% Run training for number of epochs this will be.
